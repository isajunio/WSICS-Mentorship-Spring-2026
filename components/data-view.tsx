  ...
  return (
    <div className="min-h-screen w-full" style={{ background: '#0f0c29' }}>
      <div className="text-center py-6">
        <button
          ...
          style={{
            ...
            color: '#5dcaa5', fontSize: '8px', background: 'none',
            border: '2px solid #5dcaa5', padding: '8px 12px',
        ...
        <h1 style={{
          fontFamily: "'Press Start 2P', monospace",
          color: '#ff6b9d', fontSize: '18px', letterSpacing: '2px'
        }}>
          OUR DATA
        </h1>
      </div>
      ...
      <div style={{ width: '80%', margin: '0 auto' }}>
        <div className="mb-6">
          <p style={{ fontFamily: "'Press Start 2P', monospace", color: '#5dcaa5', fontSize: '8px', marginBottom: '10px' }}>
            INTERACTIVE GRAPH
          </p>
          <iframe
