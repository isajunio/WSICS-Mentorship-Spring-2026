  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 pt-24 pb-20 relative z-10">
        ...
        {songs.length === 0 ? (
          <div
            className="text-center py-16 bg-card/80 border-2 border-border"
            style={{ boxShadow: '4px 4px 0 rgba(0,0,0,0.2)' }}
          >
            ...
            <Link
              href="/"
              className="inline-block font-mono text-xs border-2 px-6 py-3"
          ...
          <div className="space-y-3">
            {songs.map(song => (
              <RecentSongRow key={song.id} song={song} />
            ))}
          </div>
        )}
        ...
        <div className="mt-8">
          <Link
            href="/"
            className="font-mono text-xs border-2 px-6 py-3 inline-flex items-center gap-2"
            style={{ background: '#ff6b9d', color: '#000', borderColor: '#ff6b9d', boxShadow: '3px 3px 0 rgba(0,0,0,0.4)' }}
          >
            ← BACK TO HOME
          </Link>
