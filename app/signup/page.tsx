          ...
          <p className="text-muted-foreground font-sans text-xl md:text-2xl leading-relaxed">
            ...
            <form onSubmit={handleSignup}>
                <input
                    name="email"
                    placeholder="Email"
                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 mb-4"
                    type="email"
